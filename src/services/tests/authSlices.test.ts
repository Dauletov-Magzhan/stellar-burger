...
import authSlices, { getUser, initialState, initializeAuth, login, logout, register, selectGetError, selectGetUser, selectIsAuthChecked, selectIsLoading, } from "../slices/authSlices"
...
describe('Тест authSlices', () => {
    ...
    it('Тест асинхронного экшена getUser.fulfilled', () => {
        ...
        const state = authSlices(initialState, getUser.fulfilled(mockFulfilled,''));
